...
// Control of a Rover5 robot - Last update: AndreasVan 2015-03-07 Version 3.01
...
// LED for direction
// RedLed pin 5 robot drives forward
// GreenLed pin 4 robot drives backward
// YellowLed pin 3 robot turns left
// BlueLed pin 2 robot turns right

// LiquidCrystal
// LCD RS pin to digital pin 53 
// LCD Enable pin to digital pin 51
// LCD D4 pin to digital pin 49
// LCD D5 pin to digital pin 47
// LCD D6 pin to digital pin 45
// LCD D7 pin to digital pin 43
...
//Pin for IR control
int receiver = 13;                 // pin 1 of IR receiver
...
const int turntime = 1200; //Time the robot spends turning (miliseconds) // 1200ms c:a 90° - 600ms c:a 45°
int thereis;
Servo head;
